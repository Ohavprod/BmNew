...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function onLoginSuccess() {
        ...
        filterEvents();
        if(currentUser.role === 'superadmin') renderPaymentsBoard();
    ...
    window.openMyPayments = () => {
        ...
        if(!jobKey) {
            body.innerHTML = '<div class="text-center text-red-400 p-6 font-bold text-lg">לא הוגדר תפקיד במערכת. אנא ודא שעמודת "תפקיד" (עמודה E בגיליון Users) מלאה.</div>';
